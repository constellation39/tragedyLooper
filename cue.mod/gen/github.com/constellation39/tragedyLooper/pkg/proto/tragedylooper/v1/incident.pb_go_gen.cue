...
#IncidentConfig: {
	...
	incident_type?: #IncidentType @go(IncidentType) @protobuf(4,varint,opt,json=incidentType,proto3,enum=tragedylooper.v1.IncidentType)
	day?:           int32         @go(Day) @protobuf(5,varint,opt,proto3)
	trigger_conditions?: [...null | #Condition] @go(TriggerConditions,[]*Condition) @protobuf(6,bytes,rep,json=triggerConditions,proto3)
