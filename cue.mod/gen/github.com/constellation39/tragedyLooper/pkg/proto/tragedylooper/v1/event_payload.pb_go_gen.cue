...
// 循环失败事件
#LoopLossEvent: {
	incident_type?: #IncidentType @go(IncidentType) @protobuf(1,varint,opt,json=incidentType,proto3,enum=tragedylooper.v1.IncidentType)
}
...
#TragedyTriggeredEvent: {
	tragedy_type?: #IncidentType @go(TragedyType) @protobuf(1,varint,opt,json=tragedyType,proto3,enum=tragedylooper.v1.IncidentType)
}
