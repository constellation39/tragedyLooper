...
days_per_loop: 4
win_conditions: [{
	type: "END_CONDITION_TYPE_ALL_INCIDENTS_PREVENTED"
}]
lose_conditions: [{
	type: "END_CONDITION_TYPE_SPECIFIC_INCIDENT_TRIGGERED"
}]
mastermind_card_ids: [3, 4, 7, 8, 11, 13, 15]
protagonist_card_ids: [1, 2, 5, 6, 9, 10, 12, 14]
main_plot: {
	plot_type:   "PLOT_TYPE_MAIN_PLOT"
	name:        "MURDER_MYSTERY"
...
characters: [{
	character_id:     1
	hidden_role:      "ROLE_TYPE_PERSON"
	initial_location: "LOCATION_TYPE_SCHOOL"
}, {
	character_id:     2
	hidden_role:      "ROLE_TYPE_KILLER"
	...
	character_id:     35
	hidden_role:      "ROLE_TYPE_CONSPIRACY_THEORIST"
	initial_location: "LOCATION_TYPE_CITY"
}, {
	character_id:     4
	hidden_role:      "ROLE_TYPE_FRIEND"
	initial_location: "LOCATION_TYPE_CITY"
}, {
	character_id:     5
	hidden_role:      "ROLE_TYPE_PERSON"
