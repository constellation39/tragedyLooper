cards: {
	"1": {
		...
		name:       "Move"
		card_type:  "MOVEMENT"
		owner_role: "PROTAGONIST"
		effect: move_character_effect: {}
		once_per_loop: false
	}
	"2": {
		id:         2
