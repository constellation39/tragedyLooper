...
func (LocationType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_v1_location_proto_enumTypes[0].Descriptor()
}

func (LocationType) Type() protoreflect.EnumType {
	return &file_proto_v1_location_proto_enumTypes[0]
}
...
func file_proto_v1_location_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_proto_v1_location_proto_enumTypes,
	}.Build()
