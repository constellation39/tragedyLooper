...
type Card struct {
	...
	CardType          CardType               `protobuf:"varint,3,opt,name=card_type,json=cardType,proto3,enum=model.CardType" json:"card_type,omitempty"`
	OwnerRole         PlayerRole             `protobuf:"varint,4,opt,name=owner_role,json=ownerRole,proto3,enum=model.PlayerRole" json:"owner_role,omitempty"`
	...
	TargetCharacterId string                 `protobuf:"bytes,9,opt,name=target_character_id,json=targetCharacterId,proto3" json:"target_character_id,omitempty"`
	TargetLocation    LocationType           `protobuf:"varint,10,opt,name=target_location,json=targetLocation,proto3,enum=model.LocationType" json:"target_location,omitempty"`
...
const file_proto_model_card_proto_rawDesc = "" +
	"\n" +
	"\x16proto/model/card.proto\x12\x05model\x1a\x18proto/model/effect.proto\x1a\x17proto/model/enums.proto\x1a\x1aproto/model/location.proto\"\x8a\x03\n" +
	"\x04Card\x12\x0e\n" +
