...
type CharacterConfig struct {
	...
	InitialLocation LocationType           `protobuf:"varint,2,opt,name=initial_location,json=initialLocation,proto3,enum=model.LocationType" json:"initial_location,omitempty"` // 初始位置
	HiddenRole      RoleType               `protobuf:"varint,3,opt,name=hidden_role,json=hiddenRole,proto3,enum=model.RoleType" json:"hidden_role,omitempty"`                    // 此剧本中角色的秘密身份
