...
func (TargetRuleType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_model_tragedy_proto_enumTypes[0].Descriptor()
}

func (TargetRuleType) Type() protoreflect.EnumType {
	return &file_proto_model_tragedy_proto_enumTypes[0]
}
...
var file_proto_model_tragedy_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_proto_model_tragedy_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_model_tragedy_proto_goTypes = []any{
	(TargetRuleType)(0),      // 0: model.TargetRuleType
	(*TragedyCondition)(nil), // 1: model.TragedyCondition
	(*Condition)(nil),        // 2: model.Condition
	(TragedyType)(0),         // 3: model.TragedyType
	(*Ability)(nil),          // 4: model.Ability
	(LocationType)(0),        // 5: model.LocationType
}
var file_proto_model_tragedy_proto_depIdxs = []int32{
	3, // 0: model.TragedyCondition.tragedy_type:type_name -> model.TragedyType
	2, // 1: model.TragedyCondition.conditions:type_name -> model.Condition
	0, // 2: model.TragedyCondition.target_rule:type_name -> model.TargetRuleType
...
func file_proto_model_tragedy_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_proto_model_tragedy_proto_enumTypes,
