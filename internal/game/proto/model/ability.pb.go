...
func (AbilityTriggerType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_model_ability_proto_enumTypes[0].Descriptor()
}

func (AbilityTriggerType) Type() protoreflect.EnumType {
	return &file_proto_model_ability_proto_enumTypes[0]
}
...
const file_proto_model_ability_proto_rawDesc = "" +
	...
	"\x0ftarget_location\x18\t \x01(\x0e2\x13.model.LocationTypeR\x0etargetLocation*\xd4\x01\n" +
	...
	"\x1cABILITY_TRIGGER_TYPE_PASSIVE\x10\x04B\"Z github.com/user/repo/proto/modelb\x06proto3"
...
var file_proto_model_ability_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_proto_model_ability_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_model_ability_proto_goTypes = []any{
	(AbilityTriggerType)(0), // 0: model.AbilityTriggerType
	(*Ability)(nil),         // 1: model.Ability
...
var file_proto_model_ability_proto_depIdxs = []int32{
	0, // 0: model.Ability.trigger_type:type_name -> model.AbilityTriggerType
...
func file_proto_model_ability_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_proto_model_ability_proto_enumTypes,
